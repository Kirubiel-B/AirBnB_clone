...
class TestHBNBCommand_prompting(unittest.TestCase):
    """tests for testing prompting of the HBNB command interpreter."""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """tests for testing destroy from the HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """tests for testing all of the HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """tests for testing update from the HBNB command interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """tests for testing count method of HBNB comand interpreter."""
